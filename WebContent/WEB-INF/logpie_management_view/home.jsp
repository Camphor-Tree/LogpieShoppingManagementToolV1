...
<tag:logpie_common_template>
    <jsp:body>
        ...
        <h4>更新日志：</h4>
        <h5>2015-12-08 版本:Beta 1.24</h5>
        <ol>
        <li>统一了系统内所以订单列表界面:(订单管理界面，搜索界面，以及订单详情界面) 统一支持快速设置包裹信息，快速收款</li>
        <li>包裹管理界面新增快速创建包裹按钮(每个管理员会对应一个快速按钮) 目前因不用身份证号，暂用管理员身份证号作为地址</li>
        <li>修复了包裹修改界面 额外海关费用永远为0的bug</li>
        </ol>
        <h5>2015-11-27 版本:Beta 1.23</h5>
        <ol>
        <li>订单管理界面增加新功能: 快捷设置订单包裹信息。 注意：普通管理员无法修改包裹信息，因为包裹总是由北美总部更新，所以只有超级管理员可以修改包裹</li>
        </ol>
        <h5>2015-11-25 版本:Beta 1.22</h5>
        <ol>
        <li>订单管理界面增加新功能: 快捷设置用户已付款</li>
        <li>普通管理员 不设置已付国内邮费点击收款 会将用户已付款设成 售价＋当前已付国内邮费</li>
        <li>普通管理员 设置已付国内邮费点击收款 会将用户已付国内邮费 设成新设置的已付国内邮费 并将用户已付款设成 售价＋新的已付国内邮费</li>
        <li>注意：普通管理员点击收款 将不会改动公司入账</li>
        <li>超级管理员 不设置已付国内邮费点击收款 会将用户已付款设成 售价＋当前已付国内邮费， 并将公司入账设成 售价＋当前已付国内邮费</li>
        <li>超级管理员 设置已付国内邮费点击收款 会将用户已付国内邮费 设成新设置的已付国内邮费 将用户已付款设成 售价＋新的已付国内邮费  并将公司入账设成 售价＋新的已付国内邮费</li>
        </ol>
        <h5>2015-11-14 版本:Beta 1.21</h5>
        <ol>
        <li>支持微信订阅号自动本文回复的功能 仍在内测阶段</li>
        </ol>
        <h5>2015-11-02 版本:Beta 1.20</h5>
        <ol>
        <li>在搜索结果的订单列表中 显示包裹信息</li>
        <li>微信公众订阅号集成</li>
        </ol>
        <h5>2015-10-16 版本:Beta 1.19</h5>
        <ol>
        <li>在订单管理界面中支持显示公司在路上的钱</li>
        <li>包裹管理界面，修改包裹后，将重新定位到刚修改的包裹</li>
        <li>暂时修复了订单管理界面的订单号超链接会定位飘移的bug</li>
        </ol>
        <h5>2015-10-10 版本:Beta 1.18</h5>
        <ol>
        <li>导航栏的tab如果被选中，会显示高亮</li>
        <li>将改动日志中的一些英文字段改成中文</li>
        </ol>
        <h5>2015-09-21 版本:Beta 1.17</h5>
        <ol>
        <li>价格计算器支持同时输入多个需要计算的价格</li>
        <li>修复了财务报表 订单数量的bug</li>
        </ol>
