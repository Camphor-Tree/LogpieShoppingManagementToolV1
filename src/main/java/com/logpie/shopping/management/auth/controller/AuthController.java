...
public class AuthController {
	...
	public ModelAndView showSignInPage(HttpServletRequest request,
	...
	public Object verifyPassword(HttpServletRequest request,
		...
		if (email.equals("1@amazon.com") && password.equals("1")) {
			...
			Cookie cookie = cookieManager.setupAuthCookie(new Admin("id",
					"name", "email", "qq", "wechat", "phone", "passversion",
					"idnumber"));
